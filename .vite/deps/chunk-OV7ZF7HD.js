...
function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = EMPTY_OBJ) {
  ...
  if (isRef(source)) {
    ...
    getter = NOOP(true) && warnInvalidSource(source);
  }
  if (cb && deep) {
...
var PublicInstanceProxyHandlers = {
  get({ _: instance }, key) {
    ...
    if (publicGetter) {
      if (key === "$attrs") {
        track(instance, "get", key)(true) && markAttrsAccessed();
      } else if (key === "$slots") {
...
//# sourceMappingURL=chunk-OV7ZF7HD.js.map
